...
CREATE TABLE PERSON (
	...
	OTHER_CONTACT_PHONE VARCHAR(15),
	...
	BANK_ACCOUNT_OWNER VARCHAR(50),
	OBSERVATIONS VARCHAR(500),
	FOOD_ALLERGY_CHRONIC_DISEASES VARCHAR(250),
	MEMBER_NUMBER VARCHAR(20),
	HEALTH_CARD_NUMBER VARCHAR(20),
	CONSTRAINT FK_PersonFather FOREIGN KEY (ID_FATHER) REFERENCES PERSON(PERSON_ID),
	CONSTRAINT FK_PersonMother FOREIGN KEY (ID_MOTHER) REFERENCES PERSON(PERSON_ID)
	);
...
SELECT FIRSTNAME+' '+LASTNAME AS NAME, CELLPHONE_NUMBER, EMAIL FROM PERSON WHERE PERSON_ID = 1